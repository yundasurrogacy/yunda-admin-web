...
import { Card, Progress, Tag, Descriptions, Timeline, Button, Modal, Table, Row, Col, Avatar, Statistic } from 'antd'
import {
  CalendarOutlined,
  HeartOutlined,
  UserOutlined,
...
const IntendedParentMyCasePage = () => {
  ...
  const timelineEvents = [
    {
      ...
      date: '2024-01-28',
      title: '案例创建',
      description: '与代孕母亲Sarah Johnson成功匹配',
      status: 'completed',
    },
    {
      id: '2', 
      ...
      <div className="space-y-6">
        ...
        <Card title="案例信息">
          <Descriptions column={2} bordered>
            ...
            <Descriptions.Item label="代孕母亲">{currentCase?.surrogate.name}</Descriptions.Item>
          ...
          <Col xs={24} lg={12}>
            <Card title="代孕母亲信息">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <div className="font-semibold text-lg">{currentCase?.surrogate.name}</div>
                  <div className="text-gray-600">
                    {currentCase?.surrogate.age}岁，{currentCase?.surrogate.location.city}
                  </div>
                  <div className="text-sm text-gray-500 mt-2">
                    经验: {currentCase?.surrogate.experience}
                  </div>
                </div>
              </div>
              <div className="mt-4">
          ...
          <Row gutter={[16, 16]}>
            ...
            <Col xs={24} sm={6}>
              <div className="text-center">
                <div className="text-2xl font-bold text-red-600">${financialData.nextPayment.amount.toLocaleString()}</div>
                <div className="text-gray-600">下次付款</div>
                <div className="text-sm text-gray-500">{financialData.nextPayment.dueDate}</div>
              </div>
            </Col>
          </Row>
          <div className="mt-4">
        ...
        <Card title="案例相关文件" extra={<InfoCircleOutlined className="text-blue-500" />}>
          <div className="mb-4 p-3 bg-blue-50 rounded">
            <div className="text-sm text-blue-800">
              ...
              这些文件由管理员、代理机构和医疗机构负责上传和管理，您可以查看和下载。
            </div>
          </div>
          <Table 
            columns={fileColumns} 
...
export default IntendedParentMyCasePage
